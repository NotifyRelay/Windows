...
/// 功能: 保存对端设备的实时电量/充电状态。
/// 来源: Rust core 设备快照（nrc_get_device_list 的 battery 字段，带符号：正=充电/负=放电），
///       由 DeviceSnapshotStore 刷新后经 PairedDevice.ApplySnapshot 回填。
/// 纯内部运行时模型，不经 JSON 反序列化，平台端不自行采集。
/// </summary>
